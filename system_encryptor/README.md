...
Native C++ encryption module for BIT. Provides AES-256-GCM encryption, Ed25519 signing/verification, X25519 key exchange, HKDF key derivation, and license verification — all backed by BoringSSL and exposed to Kotlin via JNI.
