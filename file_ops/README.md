...
Strict, sandboxed file operations module for BIT2. All disk I/O in the app goes through this C++ native layer. Kotlin never touches the filesystem directly.
