...
Custom binary storage engine for BIT2. All app data (chats, messages, personas, memories, settings) lives in UMS. Built in C++ with JNI bridge. Kotlin layer is a thin wrapper.
