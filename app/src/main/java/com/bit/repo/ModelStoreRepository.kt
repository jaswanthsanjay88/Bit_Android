    ...
    private fun getBuiltInCuratedModels(): List<HuggingFaceModel> {
        return listOf(
            ...
            HuggingFaceModel(
                ...
                name = "Qwen 3 0.6B",
                description = "Ultra-lightweight fast Qwen model. High token output speed on any Android device.",
                fileUri = "https://huggingface.co/unsloth/Qwen2.5-0.5B-Instruct-GGUF/resolve/main/Qwen2.5-0.5B-Instruct-Q4_K_M.gguf",
                approximateSize = "380 MB",
                modelType = ModelType.GGUF,
                isZip = false,
                runOnCpu = false,
                minRamGb = 2,
                sizeBytes = 398458880L,
                icon = "qwen",
                iconUrl = "https://unpkg.com/@lobehub/icons-static-png@1.95.0/dark/qwen.png",
                tags = listOf("Chat", "Tool Calling", "Ultra Fast", "Tested")
            ),
            HuggingFaceModel(
                id = "gemma-3-1b-it-q4km",
                name = "Gemma 3 1B IT",
                description = "Google's lightweight Gemma 3 1B Instruct model. Exceptional quality for mobile tasks.",
                fileUri = "https://huggingface.co/unsloth/gemma-3-1b-it-GGUF/resolve/main/gemma-3-1b-it-Q4_K_M.gguf",
                approximateSize = "800 MB",
                modelType = ModelType.GGUF,
                isZip = false,
                runOnCpu = false,
                minRamGb = 4,
                sizeBytes = 838860800L,
                icon = "gemma",
                iconUrl = "https://unpkg.com/@lobehub/icons-static-png@1.95.0/dark/gemma.png",
                tags = listOf("Chat", "Google", "Tested")
            ),
            HuggingFaceModel(
                id = "gemma-2-2b-it-q4km",
                name = "Gemma 2 2B IT",
                description = "Google's Gemma 2 2B Instruct model. Excellent reasoning and task completion on Android.",
                fileUri = "https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/resolve/main/gemma-2-2b-it-Q4_K_M.gguf",
                approximateSize = "1.6 GB",
                modelType = ModelType.GGUF,
                isZip = false,
                runOnCpu = false,
                minRamGb = 4,
                sizeBytes = 1717986918L,
                icon = "gemma",
                iconUrl = "https://unpkg.com/@lobehub/icons-static-png@1.95.0/dark/gemma.png",
                tags = listOf("Chat", "Google", "Tested")
            ),
