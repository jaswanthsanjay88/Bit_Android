...
object AppContainer {
    ...
    /** Provides the HuggingFace API client (with auth interceptor when used via Hilt). */
    val huggingFaceApi: com.bit.network.HuggingFaceApi
        get() = com.bit.network.HuggingFaceClient.api
