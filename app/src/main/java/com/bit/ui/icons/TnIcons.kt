...
object TnIcons {
    ...
    val Sun by lazy { tabler("M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0", "M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7") }
    val Moon by lazy { tabler("M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z") }
    ...
    val GitBranch by lazy { tabler("M7 18m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0", "M7 6m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0", "M17 6m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0", "M7 8l0 8", "M9 18h1a4 4 0 0 0 4 -4v-5", "M14 9l3 0") }
    ...
    const val MCP_PATH_1 = "M 392.2 58.6 a 64.7 64.7 0 0 0 -90.2 0 l -240.7 236 a 21.6 21.6 0 0 1 -30 0 a 20.6 20.6 0 0 1 0 -29.5 L 271.8 29 a 108 108 0 0 1 150.4 0 a 103 103 0 0 1 30 88.5 a 108 108 0 0 1 90.3 29.5 l 1.3 1.2 a 103 103 0 0 1 0 147.5 L 326.2 509.3 a 7 7 0 0 0 0 9.8 l 44.7 43.8 a 20.6 20.6 0 0 1 0 29.5 a 21.6 21.6 0 0 1 -30 0 L 296 548.6 a 48 48 0 0 1 0 -68.8 l 217.7 -213.5 a 62 62 0 0 0 0 -88.5 l -1.3 -1.2 a 64.7 64.7 0 0 0 -90.1 -0.1 L 243 352.3 l -0.1 0.1 l -2.4 2.4 a 21.6 21.6 0 0 1 -30.1 0 a 20.6 20.6 0 0 1 0 -29.5 L 392.3 147 a 62 62 0 0 0 -0.1 -88.4 z"
    const val MCP_PATH_2 = "M 362.1 117.6 a 20.6 20.6 0 0 0 0 -29.5 a 21.6 21.6 0 0 0 -30 0 L 154 262.6 a 103 103 0 0 0 0 147.5 a 108 108 0 0 0 150.4 0 l 178 -174.5 a 20.6 20.6 0 0 0 0 -29.5 a 21.6 21.6 0 0 0 -30.2 0 l -178 174.5 a 64.7 64.7 0 0 1 -90.2 0 a 62 62 0 0 1 0 -88.5 z"

    /** Official Model Context Protocol (MCP) icon vector (scalable 600x600 viewport). White fill for dark mode; tintable by Icon(tint = ...). */
    val Mcp by lazy { mcpVector(Color.White) }

    /** Replaces unrelated server rack icon with the official MCP logo. */
    val McpServer by lazy { Mcp }

    /** Explicit dark-mode MCP vector (pure white fill on transparent) */
    val McpDark by lazy { mcpVector(Color.White) }

    /** Explicit light-mode MCP vector (pure black fill on transparent) */
    val McpLight by lazy { mcpVector(Color.Black) }

    fun mcpVector(fillColor: Color = Color.White): ImageVector {
        return ImageVector.Builder(
            ...
            addPath(
                pathData = PathParser().parsePathString(MCP_PATH_1).toNodes(),
                fill = SolidColor(fillColor)
            )
            addPath(
                pathData = PathParser().parsePathString(MCP_PATH_2).toNodes(),
                fill = SolidColor(fillColor)
            )
        }.build()
    }
    ...
    val Maximize by lazy { tabler("M4 8v-2a2 2 0 0 1 2 -2h2", "M4 16v2a2 2 0 0 0 2 2h2", "M16 4h2a2 2 0 0 1 2 2v2", "M16 20h2a2 2 0 0 0 2 -2v-2") }
    val Minimize by lazy { tabler("M5 9h4m0 0v-4m0 4l-5 -5", "M15 5v4m0 0h4m-4 0l5 -5", "M5 15h4m0 0v4m0 -4l-5 5", "M15 19v-4m0 0h4m-4 0l5 5") }
}
...
/**
 * Returns an official MCP vector that automatically switches between dark (white)
 * and light (black) fill based on the active system/app theme.
 */
@Composable
fun rememberMcpVector(isDark: Boolean = isSystemInDarkTheme()): ImageVector {
    return remember(isDark) {
        if (isDark) TnIcons.McpDark else TnIcons.McpLight
    }
}

/**
 * Official Model Context Protocol (MCP) Icon composable.
 * Supports both light and dark themes via tint (defaults to LocalContentColor.current).
 */
@Composable
fun McpIcon(
    modifier: Modifier = Modifier,
    tint: Color = LocalContentColor.current,
    contentDescription: String? = "Model Context Protocol"
) {
    Icon(
