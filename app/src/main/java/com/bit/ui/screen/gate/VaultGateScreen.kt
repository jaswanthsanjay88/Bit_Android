package com.bit.ui.screen.gate
...
import com.bit.viewmodel.VaultGateState
import com.bit.viewmodel.VaultGateViewModel
    ...
    LaunchedEffect(state) {
        when (state) {
            is VaultGateState.Initializing -> {
                ...
                launch { blurAmount.animateTo(30f, tween(400)) }
            }
