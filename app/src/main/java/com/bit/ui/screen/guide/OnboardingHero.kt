...
fun WireframeSphere(modifier: Modifier = Modifier) {
    ...
    Canvas(modifier = modifier) {
        ...
        for (i in 0 until 6) {
            ...
            drawOval(
                color = onBackgroundColor.copy(alpha = opacity),
...
fun SecureWaveform(modifier: Modifier = Modifier) {
    ...
    Canvas(modifier = modifier) {
        ...
        for (i in 0 until count) {
            ...
            drawRoundRect(
                color = onBackgroundColor.copy(alpha = 0.15f + 0.7f * phase),
                topLeft = Offset(x, y),
...
fun MorphingModelChips(modifier: Modifier = Modifier) {
    ...
    Canvas(modifier = modifier) {
        ...
        for (i in 0 until 3) {
            ...
            val color = if (i == 2) onBackgroundColor else onSurfaceVariantColor
