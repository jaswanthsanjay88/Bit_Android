import{j as e,r as c}from"./index-CXXFxKSd.js";import{u,B as l,X as p,c as h}from"./input-BOpLvaQi.js";import{g as x,M as g}from"./mermaid-O7DHMXV3-CKeXfwbZ.js";function m(r,s){const o=r[s];return typeof o=="string"?o:""}function y({panel:r}){const{t:s}=u(),[o,i]=c.useState("preview"),a=m(r.payload,"language"),t=x(a),n=m(r.payload,"code"),d=t==="html"||t==="svg"||t==="markdown"||t==="mermaid";c.useEffect(()=>{i(d?"preview":"source")},[d,r.payload]);const f=c.useMemo(()=>t==="html"?n:t==="svg"?`<!doctype html><html><body style="margin:0;display:flex;align-items:center;justify-content:center;padding:16px;">${n}</body></html>`:t==="mermaid"?`<!doctype html>
<html>
  <head>
    <meta charset="UTF-8" />
