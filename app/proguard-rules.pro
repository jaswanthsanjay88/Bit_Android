...
# -- Core App Classes --
-keep class com.bit.model.** { *; }
-keep class com.bit.models.** { *; }
-keep class com.bit.network.** { *; }
-keep class com.bit.activity.** { *; }
-keep class com.bit.viewmodel.** { *; }
-keep class com.bit.viewModel.** { *; }
-keep class com.bit.ui.** { *; }
-keep class com.bit.repo.** { *; }
-keep class com.bit.worker.** { *; }
-keep class com.bit.engine.** { *; }
-keep class com.bit.service.** { *; }
-keep class com.bit.util.** { *; }
-keep class com.bit.utils.** { *; }
-keep class com.bit.plugins.** { *; }
...
-keep class com.bit.global.** { *; }
-keep class com.dark.plugins.api.** { *; }

# Network data classes (for Retrofit)
-keep class com.bit.network.HuggingFaceRepoResponse { *; }
-keep class com.bit.network.HuggingFaceFileResponse { *; }

# Worker data classes (for model parsing and loading)
-keep class com.bit.worker.DiffusionConfig { *; }
-keep class com.bit.worker.DiffusionInferenceParams { *; }
-keep class com.bit.worker.GGUFModelInfo { *; }
-keep class com.bit.worker.DiffusionModelInfo { *; }
-keep class com.bit.worker.ModelInfo { *; }
-keep class * extends com.bit.worker.ModelLoadResult { *; }

# -- Data Classes & Enums --
-keepclassmembers class com.bit.models.** {
    *;
}

# Explicit model subdirectories (for better serialization protection)
-keep class com.bit.models.data.** { *; }
-keep class com.bit.models.engine_schema.** { *; }
-keep class com.bit.models.enums.** { *; }
-keep class com.bit.models.messages.** { *; }
-keep class com.bit.models.plugins.** { *; }
-keep class com.bit.models.state.** { *; }
-keep class com.bit.models.vault.** { *; }

# Keep sealed classes and their subclasses
-keep class * extends com.bit.models.state.AppState { *; }
-keep class * extends com.bit.models.plugins.ToolState { *; }
-keep class * extends com.bit.service.ModelDownloadService$DownloadState { *; }
-keep class * extends com.bit.plugins.PluginExecutionResult { *; }
...
-keep class com.bit.database.** { *; }
-keep class com.bit.models.table_schema.** { *; }
-keep class com.bit.models.converters.** { *; }
...
-keep,includedescriptorclasses class com.bit.**$$serializer { *; }
-keepclassmembers class com.bit.** {
    *** Companion;
}
-keepclasseswithmembers class com.bit.** {
    kotlinx.serialization.KSerializer serializer(...);
}
-keep @kotlinx.serialization.Serializable class com.bit.** { *; }
...
-keep class com.bit.engine.EmbeddingEngine$** { *; }
-keepclassmembers class com.bit.engine.EmbeddingEngine {
    *;
}
...
-keep class com.bit.plugins.api.SuperPlugin { *; }
-keepclassmembers class com.bit.plugins.** {
    *;
}
-keep class com.bit.plugins.PluginManager$MultiTurnToolResult { *; }

# -- Vault (serialization helper + data classes) --
-keepclassmembers class com.bit.vault.** {
    *;
}

# -- Hilt DI modules & qualifiers --
-keep @dagger.Module class com.bit.di.** { *; }
-keep @javax.inject.Qualifier class com.bit.di.** { *; }

# -- RAG & NeuronGraph --
-keep class com.bit.neuron_example.** { *; }
-keepclassmembers class com.bit.neuron_example.** {
    *;
}

# Keep NeuronGraph serializable classes explicitly
-keep class com.bit.neuron_example.GraphSettings { *; }
-keep class com.bit.neuron_example.SourceType { *; }
-keep class com.bit.neuron_example.EdgeType { *; }
-keep class com.bit.neuron_example.NeuronEdge { *; }
-keep class com.bit.neuron_example.NodeMetadata { *; }
-keep class com.bit.neuron_example.NeuronNode { *; }
-keep class com.bit.neuron_example.QueryResult { *; }
-keep class com.bit.neuron_example.GraphStats { *; }
...
-keep class com.bit.util.DocumentParser { *; }
-keepclassmembers class com.bit.util.DocumentParser {
    *;
}
